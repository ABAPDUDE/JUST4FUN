...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to YCL_FLIGHT
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to YCL_FLIGHT .
  types:
...
CLASS YCB_FLIGHT IMPLEMENTATION.
...
*      IMPORTING I_FLIGHT_DATE TYPE /DMO/FLIGHT_DATE
*      RETURNING RESULT TYPE REF TO YCL_FLIGHT
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-CARRIER_ID = I_CARRIER_ID.
  BUSINESS_KEY-CONNECTION_ID = I_CONNECTION_ID.
  BUSINESS_KEY-FLIGHT_DATE = I_FLIGHT_DATE.
*>
...
*<  Generated from mapping:
          THE_OBJECT->CARRIER_ID = I_CARRIER_ID.
          THE_OBJECT->CONNECTION_ID = I_CONNECTION_ID.
          THE_OBJECT->FLIGHT_DATE = I_FLIGHT_DATE.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_CARRIER_ID = BUSINESS_KEY-CARRIER_ID
                 I_CONNECTION_ID = BUSINESS_KEY-CONNECTION_ID
                 I_FLIGHT_DATE = BUSINESS_KEY-FLIGHT_DATE
...
*<Generated from mapping:
  E_BUSINESS_KEY-CARRIER_ID  = I_DB_DATA-CARRIER_ID.
  E_BUSINESS_KEY-CONNECTION_ID  = I_DB_DATA-CONNECTION_ID.
  E_BUSINESS_KEY-FLIGHT_DATE  = I_DB_DATA-FLIGHT_DATE.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to YCL_FLIGHT,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-CARRIER_ID = THE_OBJECT->CARRIER_ID.
    OBJECT_DATA_ITEM-CONNECTION_ID = THE_OBJECT->CONNECTION_ID.
    OBJECT_DATA_ITEM-FLIGHT_DATE = THE_OBJECT->FLIGHT_DATE.
    OBJECT_DATA_ITEM-PRICE = THE_OBJECT->PRICE.
    OBJECT_DATA_ITEM-CURRENCY_CODE = THE_OBJECT->CURRENCY_CODE.
    OBJECT_DATA_ITEM-PLANE_TYPE_ID = THE_OBJECT->PLANE_TYPE_ID.
    OBJECT_DATA_ITEM-SEATS_MAX = THE_OBJECT->SEATS_MAX.
    OBJECT_DATA_ITEM-SEATS_OCCUPIED = THE_OBJECT->SEATS_OCCUPIED.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CARRIER_ID'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = '/DMO/FLIGHT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CARRIER_ID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CONNECTION_ID'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = '/DMO/FLIGHT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CONNECTION_ID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'FLIGHT_DATE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = '/DMO/FLIGHT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'FLIGHT_DATE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CURRENCY_CODE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = '/DMO/FLIGHT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CURRENCY_CODE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PLANE_TYPE_ID'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = '/DMO/FLIGHT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PLANE_TYPE_ID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SEATS_MAX'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = '/DMO/FLIGHT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SEATS_MAX'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SEATS_OCCUPIED'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = '/DMO/FLIGHT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SEATS_OCCUPIED'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO YCL_FLIGHT.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->CARRIER_ID,
             THE_OBJECT->CONNECTION_ID,
             THE_OBJECT->FLIGHT_DATE,
             THE_OBJECT->PRICE,
             THE_OBJECT->CURRENCY_CODE,
             THE_OBJECT->PLANE_TYPE_ID,
             THE_OBJECT->SEATS_MAX,
             THE_OBJECT->SEATS_OCCUPIED.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type /DMO/FLIGHT.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB__DMO_FLIGHT> type /DMO/FLIGHT.
*>
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB__DMO_FLIGHT>.

*< Generated from mapping:
    DB_DATA-CARRIER_ID = <FS_DB__DMO_FLIGHT>-CARRIER_ID.
    DB_DATA-CONNECTION_ID = <FS_DB__DMO_FLIGHT>-CONNECTION_ID.
    DB_DATA-FLIGHT_DATE = <FS_DB__DMO_FLIGHT>-FLIGHT_DATE.
    DB_DATA-PRICE = <FS_DB__DMO_FLIGHT>-PRICE.
    DB_DATA-CURRENCY_CODE = <FS_DB__DMO_FLIGHT>-CURRENCY_CODE.
    DB_DATA-PLANE_TYPE_ID = <FS_DB__DMO_FLIGHT>-PLANE_TYPE_ID.
    DB_DATA-SEATS_MAX = <FS_DB__DMO_FLIGHT>-SEATS_MAX.
    DB_DATA-SEATS_OCCUPIED = <FS_DB__DMO_FLIGHT>-SEATS_OCCUPIED.
*>
...
*< Generated from mapping:
  select * from /DMO/FLIGHT
           ...
           where /DMO/FLIGHT~CARRIER_ID = I_BUSINESS_KEY_TAB-CARRIER_ID
             and /DMO/FLIGHT~CONNECTION_ID =
             I_BUSINESS_KEY_TAB-CONNECTION_ID
             and /DMO/FLIGHT~FLIGHT_DATE =
             I_BUSINESS_KEY_TAB-FLIGHT_DATE.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-CARRIER_ID = BUSINESS_KEY-CARRIER_ID.
    <FS_OBJECT_DATA>-CONNECTION_ID = BUSINESS_KEY-CONNECTION_ID.
    <FS_OBJECT_DATA>-FLIGHT_DATE = BUSINESS_KEY-FLIGHT_DATE.
*>
...
* * /DMO/FLIGHT: internal tables for mass operation
  data DB_ITB_/DMO/FLIGHT type STANDARD TABLE OF /DMO/FLIGHT.
  data DB_UTB_/DMO/FLIGHT type STANDARD TABLE OF /DMO/FLIGHT.
  data DB_DTB_/DMO/FLIGHT type STANDARD TABLE OF /DMO/FLIGHT.

* * /DMO/FLIGHT: headlines for tables
  data DB_ILN_/DMO/FLIGHT type /DMO/FLIGHT.
  data DB_ULN_/DMO/FLIGHT type /DMO/FLIGHT.
  data DB_DLN_/DMO/FLIGHT type /DMO/FLIGHT.
...
*< Generated from mapping:
   ...
   DB_ILN_/DMO/FLIGHT-PRICE = <FS_INSERT>-PRICE.
   DB_ILN_/DMO/FLIGHT-CURRENCY_CODE = <FS_INSERT>-CURRENCY_CODE.
   DB_ILN_/DMO/FLIGHT-PLANE_TYPE_ID = <FS_INSERT>-PLANE_TYPE_ID.
   DB_ILN_/DMO/FLIGHT-SEATS_MAX = <FS_INSERT>-SEATS_MAX.
   DB_ILN_/DMO/FLIGHT-SEATS_OCCUPIED = <FS_INSERT>-SEATS_OCCUPIED.


   DB_ILN_/DMO/FLIGHT-CARRIER_ID = <FS_INSERT>-CARRIER_ID.
   DB_ILN_/DMO/FLIGHT-CONNECTION_ID = <FS_INSERT>-CONNECTION_ID.
   DB_ILN_/DMO/FLIGHT-FLIGHT_DATE = <FS_INSERT>-FLIGHT_DATE.
   append DB_ILN_/DMO/FLIGHT to DB_ITB_/DMO/FLIGHT.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_/DMO/FLIGHT-PRICE = <FS_UPDATE>-PRICE.
   DB_ULN_/DMO/FLIGHT-CURRENCY_CODE = <FS_UPDATE>-CURRENCY_CODE.
   DB_ULN_/DMO/FLIGHT-PLANE_TYPE_ID = <FS_UPDATE>-PLANE_TYPE_ID.
   DB_ULN_/DMO/FLIGHT-SEATS_MAX = <FS_UPDATE>-SEATS_MAX.
   DB_ULN_/DMO/FLIGHT-SEATS_OCCUPIED = <FS_UPDATE>-SEATS_OCCUPIED.


   DB_ULN_/DMO/FLIGHT-CARRIER_ID = <FS_UPDATE>-CARRIER_ID.
   DB_ULN_/DMO/FLIGHT-CONNECTION_ID = <FS_UPDATE>-CONNECTION_ID.
   DB_ULN_/DMO/FLIGHT-FLIGHT_DATE = <FS_UPDATE>-FLIGHT_DATE.
   append DB_ULN_/DMO/FLIGHT TO DB_UTB_/DMO/FLIGHT.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_/DMO/FLIGHT-CARRIER_ID = <FS_DELETE>-BUSINESS_KEY-CARRIER_ID.
    DB_DLN_/DMO/FLIGHT-CONNECTION_ID =
    <FS_DELETE>-BUSINESS_KEY-CONNECTION_ID.
    DB_DLN_/DMO/FLIGHT-FLIGHT_DATE =
    <FS_DELETE>-BUSINESS_KEY-FLIGHT_DATE.

    append DB_DLN_/DMO/FLIGHT TO DB_DTB_/DMO/FLIGHT.
...
* * DB Deletes
  delete /DMO/FLIGHT FROM TABLE DB_DTB_/DMO/FLIGHT.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert /DMO/FLIGHT FROM TABLE DB_ITB_/DMO/FLIGHT
...
* * DB Updates
  update /DMO/FLIGHT FROM TABLE DB_UTB_/DMO/FLIGHT ##WARN_OK.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-CARRIER_ID.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-CONNECTION_ID.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-FLIGHT_DATE.
  concatenate RESULT COMP_STRING into RESULT.
*>
...
*<  Generated from mapping:
  THE_OBJECT->CARRIER_ID = I_OBJECT_DATA-CARRIER_ID.
  THE_OBJECT->CONNECTION_ID = I_OBJECT_DATA-CONNECTION_ID.
  THE_OBJECT->FLIGHT_DATE = I_OBJECT_DATA-FLIGHT_DATE.
  THE_OBJECT->PRICE = I_OBJECT_DATA-PRICE.
  THE_OBJECT->CURRENCY_CODE = I_OBJECT_DATA-CURRENCY_CODE.
  THE_OBJECT->PLANE_TYPE_ID = I_OBJECT_DATA-PLANE_TYPE_ID.
  THE_OBJECT->SEATS_MAX = I_OBJECT_DATA-SEATS_MAX.
  THE_OBJECT->SEATS_OCCUPIED = I_OBJECT_DATA-SEATS_OCCUPIED.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to YCL_FLIGHT.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->CARRIER_ID = I_BUSINESS_KEY-CARRIER_ID.
  NEW_OBJECT->CONNECTION_ID = I_BUSINESS_KEY-CONNECTION_ID.
  NEW_OBJECT->FLIGHT_DATE = I_BUSINESS_KEY-FLIGHT_DATE.
* >
